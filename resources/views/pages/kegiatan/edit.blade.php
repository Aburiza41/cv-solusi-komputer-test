<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <div>
                <a href="{{ route('master.kegiatan.index') }}" class="text-indigo-600 hover:text-indigo-900">Kembali</a>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    {{-- Formulir Ubah Dinas --}}
                    <form method="POST" action="{{ route('master.kegiatan.update', $kegiatan->kode) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="kode" id="kode"
                                ...
                                value="{{ old('kode', $kegiatan->kode) }}" required readonly>
                            @error('kode')
